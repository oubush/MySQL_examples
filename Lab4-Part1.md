...
+ Просмотрите все записи созданной вами таблицы с помощью оператора SELECT.
  ...
  Проведите сортировку записей по полю BirthDate (дата рождения) по убыванию с помощью выражений ORDER BY и DESC.
   ...
   Обратите внимание, как MySQL работает с типом данных DATE. Самостоятельно попробуйте провести сортировку по разным полям в убыванию (DESC) и возрастанию (ASC).
...
+ Завершите запись команд в файл и отправьте ваш файл "L4-P1-XXXФамилия.log" на проверку (в элементе курса "Сдать на проверку 4 практическое задание").
