...
MySQL Workbench позволяет ...

+ Откройте ... 

В будущем вы можете писать и запускать команды SQL, используя интерфейс Workbench вместо консоли, если вам так будет удобнее.

+ Откройте ... модель ... Запустим тестовую ... Так выглядит ... Вы можете создать здесь схему базы данных ... Последовательность этапов похожа на то, что вы делали во второй практической работе в программе MS Access. ... Так как мы уже создали базу данных, мы можем пойти обратным путем - на основе существующей базы данных создадим диаграмму. Для этого откройте ... все шаги с картинками ... Сохраните эту модель в формате и отправьте на проверку вместе с лог-файлом "L4-P2-XXXФамилия.log", который вы создали ранее.
