...
# Текст находится в стадии редактирования!!!

## Часть 2

В ходе выполнения второй части практического задания 4 ... (опираться на пратиктическое задание 2) 

### Задание 1. Создание базы данных "Деканат"
