...
Так как мы уже создали базу данных с помощью консоли, мы можем пойти обратным путем - на основе существующей базы данных создадим диаграмму. Для этого откройте ... все шаги с картинками ... Сохраните эту модель в формате и отправьте на проверку вместе с лог-файлом "L4-P2-XXXФамилия.log", который вы создали ранее.
